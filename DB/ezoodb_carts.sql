...
CREATE TABLE `carts` (
  ...
  KEY `prodId` (`prodId`),
  KEY `userId` (`userId`),
  CONSTRAINT `carts_ibfk_1` FOREIGN KEY (`prodId`) REFERENCES `prods` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `carts` VALUES (38,1,44,2,'2024-03-09 12:48:09','2024-03-09 12:48:09');
