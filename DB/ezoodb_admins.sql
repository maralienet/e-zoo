...
CREATE TABLE `admins` (
  ...
  `accessLvl` int NOT NULL DEFAULT '3',
  `userId` int DEFAULT NULL,
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `admins_ibfk_1` (`userId`),
...
INSERT INTO `admins` VALUES (1,3,1,'2024-03-02 14:21:44','2024-03-02 14:21:44'),(2,1,2,'2024-03-02 14:21:44','2024-03-02 14:21:44'),(3,3,3,'2024-03-02 14:21:44','2024-03-02 14:21:44');
